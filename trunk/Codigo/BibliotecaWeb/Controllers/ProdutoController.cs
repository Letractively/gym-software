...
namespace BibliotecaWeb.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public ActionResult RelatorioProdutoEstoqueBaixo()
        {
            LocalReport relatorio = new LocalReport();

            //Caminho onde o arquivo do Report Viewer está localizado
            relatorio.ReportPath = Server.MapPath("~/Reports/ReportListaProdutosEstoqueBaixo.rdlc");
            //Define o nome do nosso DataSource e qual rotina irá preenche-lo, no caso, nosso método criado anteriormente
            relatorio.DataSources.Add(new ReportDataSource("DataSet1", gProduto.ObterProdutosEstoqueBaixo()));
